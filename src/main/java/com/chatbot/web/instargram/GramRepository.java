...
interface MemberRepository extends JpaRepository<GramMember, String> {
    /*  @Query(
    ...
    public GramMember profileUpdate(String path, String id);
...
interface RoomRepository extends JpaRepository<GramRoom, Long> {
    @Query(
            value = "select * from tbl_room m where m.roomprogress=1 and m.roomhostid=:roomhostid "
            , nativeQuery = true
    )
    public List<GramRoom> hostProgressEx(String roomhostid);
    ...
    public List<GramRoom> hostNotProgressEx(String memberid);
    ...
    public List<GramRoom> MemberProgressEx(String memberid);
    ...
    public List<GramRoom> MemberNotProgressEx(String memberid);
    ...
    public List<GramRoom> selectall();
    ...
    public GramRoom roomUpdate(String path, String id);
    ...
    public GramRoom selecthost(Long roomno);
    ...
    public GramRoom roomphotoUpdate(String path, String roomno);
...
interface EnterRepository extends JpaRepository<GramMember, Integer>{
    @Query(
            value = "insert into tbl_members_rooms (members_memberid, rooms_roomno) values(:memberid, :roomno)",
            nativeQuery = true
    )
    public void enter(GramMember memberid, int roomno);
